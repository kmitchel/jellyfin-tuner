...
The focus of this project will return to a minimal solution to connect Jellyfin to OTA tuners, providing a EPG service and streaming the raw mpeg/ts to Jellyfin for further processing. https://github.com/kmitchel/ZapLink is a more comprehensive solution, that offers flexible transcoding, DVR functionality, and a feature rich program guide.
