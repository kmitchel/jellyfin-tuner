...
async function handleStream(req, res) {
    ...
    if (strategy === 'nvenc') {
        ...
        if (codec === 'h265' || codec === 'hevc') {
            ffmpegArgs.push('-c:v', 'libx265', '-preset', 'ultrafast', '-tune', 'zerolatency');
        } else if (codec === 'av1') {
            ffmpegArgs.push('-c:v', 'libsvtav1', '-preset', '10'); // SVT-AV1 uses numeric presets (0-13), 10+ is good for real-time
        } else {
